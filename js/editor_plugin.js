		...
		tinymce.create(
			"tinymce.plugins.echothemeShortcodes",
			{
				...
				createControl:function(d,e)
				{
					...
					if(d=="ewd_bootpress_shortcodes_button"){
					
						d=e.createMenuButton( "ewd_bootpress_shortcodes_button",{
							title:"Insert Theme Shortcodes",
							icons:false,
							image : abs_url + '/../img/icon-e-small.png'
							});
							
							var a=this;d.onRenderMenu.add(function(c,b){
								
								a.addImmediate(b, "Hero Unit", '[hero]<br>content,<br>[/hero]');
								a.addImmediate(b, 'Page Header', '[header]<br><h1>Content Here</h1><br>[/header]')
								a.addImmediate(b, "Button", '[button label="" url=""]');
								a.addImmediate(b, 'Grid Row', '[row]<br><br>Add Cols here<br><br>[/row]');
								a.addImmediate(b, 'Grid Column', '[col span=4]<br><br>Content Here<br><br>[/col]');
